StockBalanceDisplay = angular.module('StockBalanceDisplay', ['ngTouch', 'ui.grid',
...
function ($rootScope, $scope, $log, $http, modal, uiGridConstants, uiGridExporterConstants, uiGridExporterService, $timeout) {
      ...
      $scope.ShowDetail = function () {
         ...
         {
             window.open('/Display_StockBalance/DocumentMenu/?DocTypeId=' + DocTypeId + '&DocId=' + DocId, '_blank');
             return;
         ...
         if (rowCol.row.entity.Dimension4Name != null)
          ...
          $.ajax({
              ...
              cache: false,
              type: "POST",
              url: '/Display_StockBalance/SaveCurrentSetting',
          ...
          if (Count > 0) {
              if (e.keyCode == 27) { // escape key maps to keycode `27`
                  $.ajax({
                      ...
                      cache: false,
                      type: "POST",
                      url: '/Display_StockBalance/GetParameterSettingsForLastDisplay',
                      success: function (result) {
                          ...
                          CustomSelectFunction($("#GroupOn"), '/Display_StockBalance/GetGroupOn', '/Display_StockBalance/SetGroupOn', ' ', true, 0);
                          CustomSelectFunction($("#ShowBalance"), '/Display_StockBalance/GetShowBalence', '/Display_StockBalance/SetShowBalence', ' ', false, 0);
                          ///    ////
                          ...
                          if (result.ProductType == null)
                              $("#ProductNatureName").select2('data', { id: '', text: '' });
                          if (result.ProductType == null)
      ...
      function SetCaptions()
      {
          $.ajax({
              ...
              cache: false,
              type: "POST",
              url: '/Display_StockBalance/GetDivisionSettings',
              success: function (result) {
      ...
      $scope.BindData = function ()
      {
        ...
        //  saveProductId();
          ...
          $.ajax({
              url: '/Display_StockBalance/DisplayStockBalanceFill/' + $(this).serialize(),
              ...
              success: function (result) {
                  ...
                  if (result.Success == true) {
                      $scope.gridOptions.columnDefs = new Array();
                               ...
                               $scope.gridOptions.columnDefs.push({ field: 'ProcessId', width: 200, visible: false }); //Dimension3Id
                               $scope.gridOptions.columnDefs.push({ field: 'GodownId', width: 200, visible: false });
                               $scope.gridOptions.columnDefs.push({ field: 'Dimension1Id', width: 200, visible: false });
                               $scope.gridOptions.columnDefs.push({ field: 'Dimension2Id', width: 200, visible: false });
                               $scope.gridOptions.columnDefs.push({ field: 'Dimension3Id', width: 200, visible: false });
                               $scope.gridOptions.columnDefs.push({ field: 'Dimension4Id', width: 200, visible: false });
                               $scope.gridOptions.columnDefs.push({ field: 'ProductId', width: 200, visible: false, });
                            //   $scope.gridOptions.columnDefs.push({ field: 'ProductNatureId', width: 200, visible: false, });
                            //   $scope.gridOptions.columnDefs.push({ field: 'ProductNatureName', width: 200, visible: false, });
                               ...
                               $scope.gridOptions.columnDefs.push({ field: 'Dimension1Name', displayName: 'Shade', width: 150, visible: true, aggregationHideLabel: true, headerCellClass: 'text-right header-text', footerCellClass: 'text-right ', cellClass: 'cell-text', cellTemplate: '<div class="ui-grid-cell-contents my-cell ng-binding ng-scope " ng-dblclick="grid.appScope.ShowDetail()"  ng-bind-html="COL_FIELD | trusted">  </div>', });
                               $scope.gridOptions.columnDefs.push({ field: 'Dimension2Name', displayName: 'Design', width: 150, visible: true, aggregationHideLabel: true, headerCellClass: 'text-right header-text', footerCellClass: 'text-right ', cellClass: 'cell-text', cellTemplate: '<div class="ui-grid-cell-contents my-cell ng-binding ng-scope " ng-dblclick="grid.appScope.ShowDetail()"  ng-bind-html="COL_FIELD | trusted">  </div>', });
                               $scope.gridOptions.columnDefs.push({ field: 'Dimension3Name', displayName: 'Size', width: 150, visible: true, aggregationHideLabel: true, headerCellClass: 'text-right header-text', footerCellClass: 'text-right ', cellClass: 'cell-text', cellTemplate: '<div class="ui-grid-cell-contents my-cell ng-binding ng-scope " ng-dblclick="grid.appScope.ShowDetail()"  ng-bind-html="COL_FIELD | trusted">  </div>', });
                               $scope.gridOptions.columnDefs.push({ field: 'Dimension4Name', displayName: 'Fabric', width: 150, visible: true, aggregationHideLabel: true, headerCellClass: 'text-right header-text', footerCellClass: 'text-right ', cellClass: 'cell-text', cellTemplate: '<div class="ui-grid-cell-contents my-cell ng-binding ng-scope " ng-dblclick="grid.appScope.ShowDetail()"  ng-bind-html="COL_FIELD | trusted">  </div>', });
                               ...
                               $scope.gridOptions.columnDefs.push({ field: 'GodownName', width: 100, cellClass: 'cell-text ', headerCellClass: 'header-text', cellTemplate: '<div class="ui-grid-cell-contents my-cell ng-binding ng-scope " ng-dblclick="grid.appScope.ShowDetail()"  ng-bind-html="COL_FIELD | trusted">  </div>', });
                               ...
                               $scope.gridOptions.columnDefs.push({ field: 'Balance', displayName: 'Balance', width: 150, aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, headerCellClass: 'text-right header-text', footerCellClass: 'text-right ', cellClass: 'text-right cell-text',});
