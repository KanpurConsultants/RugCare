        ...
        public ActionResult Submitted(int Id, string IndexType, string UserRemark, string IsContinue)
        {
            ...
            if (ModelState.IsValid)
            {
                if (User.Identity.Name == pd.ModifiedBy || UserRoles.Contains("Admin"))
                {
                    ...
                    IEnumerable<SaleInvoiceLineViewModel> SIL = new SaleInvoiceLineService(_unitOfWork).GetDirectSaleInvoiceLineListForIndex(Id);

                    foreach (SaleInvoiceLineViewModel item in SIL)
                    {
                    ...
                    SaleInvoiceHeaderDetail saleinvoiceheaderdetail = db.SaleInvoiceHeaderDetail.Find(Id);
                    saleinvoiceheaderdetail.BaleNoSeries = GetBaleNoSeries(BaleNoStr, Id);
