...
namespace Jobs.Areas.Rug.Controllers
{
    ...
    [Authorize]
    public class WeavingOrderInspectionLineController : System.Web.Mvc.Controller
    {
        ...
        public WeavingOrderInspectionLineController(IUnitOfWork unitOfWork, IExceptionHandlingService exec)
        {
        ...
        public ActionResult _CreatePost(JobOrderInspectionLineViewModel svm)
        {
            ...
            if (ModelState.IsValid && BeforeSave && !EventException)
            {
                ...
                else
                {
                    ...
                    temp1.InspectedLength = svm.InspectedLength;
                    temp1.InspectedWidth = svm.InspectedWidth;
                    temp1.InspectedUnitId = svm.InspectedUnitId;
