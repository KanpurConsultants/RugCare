        ...
        public ActionResult JobOrderTextImport(int id, int? GodownId, Decimal? Rate)
        {
            ...
            do
            {
                ...
                if (Line != null)
                {
                    ...
                    StrQry += " Insert Into @TmpTable (ProcessCode, ProductUidName, Pcs, SupplierCode, JobOrderByCode) ";
                    StrQry += " Values ('" + StrArr[7] + "', '" + StrArr[13] + "', '" + StrArr[15] + "', '" + StrArr[9] + "', '" + StrArr[11] + "')";
                }
            ...
            string mQry = "";
            mQry = StrQry + " Select ProcessCode, ProductUidName, Pcs, SupplierCode, JobOrderByCode " +
                " From @TmpTable " +
            ...
            for (i = 0; i <= TextData.Tables[0].Rows.Count - 1; i++)
            {
                ...
                dr["Pcs"] = TextData.Tables[0].Rows[i]["Pcs"];
