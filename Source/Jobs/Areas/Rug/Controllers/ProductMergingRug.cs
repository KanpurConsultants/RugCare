...
{
    [Authorize]
    public class ProductMergingRugController : System.Web.Mvc.Controller
    {
        ...
        public ProductMergingRugController(IUnitOfWork unitOfWork)
        {
        ...
        public ActionResult ProductMergingRug()
        {
        ...
        public ActionResult DatabaseOperation(IList<MergingExcel>  MergingRecordList)
        {
            ...
            else
            {
                ...
                if (ErrorText != "")
                {
                    ...
                    DataTableSessionVarName = User.Identity.Name.ToString() + "ImportDataProductMergingRug";
        ...
        public ActionResult GetCustomProducts(string searchTerm, int pageSize, int pageNum, int filter, int MainProductId)//DocTypeId
        {
            //Boolean isShowAllProducts = true;

            var Query = new ProductService(_unitOfWork).GetRugWithInactiveColour(searchTerm, MainProductId);
