...
{
    [Authorize]
    public class ColourMergingController : System.Web.Mvc.Controller
    {
        ...
        public ColourMergingController(IUnitOfWork unitOfWork)
        {
        ...
        public ActionResult ColourMerging()
        {
        ...
        public ActionResult DatabaseOperation(IList<MergingExcel>  MergingRecordList)
        {
            ...
            {
                sqlConnection.Open();
                using (SqlCommand cmd = new SqlCommand("" + ConfigurationManager.AppSettings["DataBaseSchema"] + ".sp_MergeColours"))
                {
            ...
            else
            {
                ...
                if (ErrorText != "")
                {
                    ...
                    DataTableSessionVarName = User.Identity.Name.ToString() + "ImportDataColourMerging";
