...
namespace Jobs.Areas.Rug.Controllers
{
    ...
    public class WeavingOrderWizardController : System.Web.Mvc.Controller
    {
        ...
        public ActionResult Post(JobOrderHeaderViewModel svm)
        {
            ...
            var   ListPODate = (from p in ProdOrdersAndQtys
                                join L in db.ProdOrderLine  on p.ProdOrderLineId equals L.ProdOrderLineId
                                join H in db.ProdOrderHeader on L.ProdOrderHeaderId equals H.ProdOrderHeaderId
                                select new 
                                {
                                 DocDate = H.DocDate,
                                 }).ToList();
        ...
        public JsonResult GetBarCodesForReferenceId(int Id)//filter:PersonId
        {
            var temp = new JobOrderLineService(_unitOfWork).GetBarCodesForWeavingWizard(Id, "").ToList();
