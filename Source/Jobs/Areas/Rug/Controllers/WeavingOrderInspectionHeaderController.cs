...
{
    [Authorize]
    public class WeavingOrderInspectionHeaderController : System.Web.Mvc.Controller
    {
        ...
        public WeavingOrderInspectionHeaderController(IUnitOfWork unitOfWork, IExceptionHandlingService exec)
        {
        ...
        public ActionResult Submitted(int Id, string IndexType, string UserRemark, string IsContinue)
        {
            ...
            if (ModelState.IsValid && BeforeSave && !EventException)
            {
                ...
                if (User.Identity.Name == pd.ModifiedBy || UserRoles.Contains("Admin"))
                {
                    ...
                    string ReturnUrl = System.Configuration.ConfigurationManager.AppSettings["CurrentDomain"] + "/" + "WeavingOrderInspectionHeader" + "/" + "Index" + "/" + pd.DocTypeId + "?IndexType=" + IndexType;
                    if (!string.IsNullOrEmpty(IsContinue) && IsContinue == "True")
                    {
                        ...
                        if (nextId == 0)
                        {
                            ...
                            if (PendingtoSubmitCount > 0)
                                ...
                                ReturnUrl = System.Configuration.ConfigurationManager.AppSettings["CurrentDomain"] + "/" + "Rug/WeavingOrderInspectionHeader" + "/" + "Index_PendingToSubmit" + "/" + pd.DocTypeId + "?IndexType=" + IndexType;
                            else
                                //return RedirectToAction("Index", new { id = pd.DocTypeId });
                                ReturnUrl = System.Configuration.ConfigurationManager.AppSettings["CurrentDomain"] + "/" + "Rug/WeavingOrderInspectionHeader" + "/" + "Index" + "/" + pd.DocTypeId + "?IndexType=" + IndexType;

                        }
                        ReturnUrl = System.Configuration.ConfigurationManager.AppSettings["CurrentDomain"] + "/" + "Rug/WeavingOrderInspectionHeader" + "/" + "Submit" + "/" + nextId + "?TransactionType=submitContinue&IndexType=" + IndexType;
                    }
                    else
                    {
                        ReturnUrl = System.Configuration.ConfigurationManager.AppSettings["CurrentDomain"] + "/" + "Rug/WeavingOrderInspectionHeader" + "/" + "Index" + "/" + pd.DocTypeId + "?IndexType=" + IndexType;
