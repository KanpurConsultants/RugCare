                ...
                foreach (var item in svm.MaterialPlanLineViewModel)
                {
                    if (item.Qty > 0)
                    {
                        ...
                        foreach (var item2 in prodorderline)
                        {
                            ...
                            var MPlan =  context.MaterialPlanLine.Local.Where(m => m.ProductId == line.ProductId && m.Dimension1Id == line.Dimension1Id && m.Dimension2Id == line.Dimension2Id && m.Dimension3Id == line.Dimension3Id && m.Dimension4Id == line.Dimension4Id && m.ProcessId == line.ProcessId).FirstOrDefault();
                            if (MPlan != null)
                                line.MaterialPlanLineId = MPlan.MaterialPlanLineId;
