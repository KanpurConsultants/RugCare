...
namespace Jobs.Controllers
{
    ...
    public class FinancialDisplayController : System.Web.Mvc.Controller
    {
        ...
        public JsonResult FinancialDisplayFill(FinancialDisplayViewModel vm)
        {
            ...
            if (vm.ReportType.ToUpper() == ReportType_TrialBalance.ToUpper())
            {
                ...
                else if (vm.DisplayType.ToUpper() == DisplayType_Summary.ToUpper())
                {
                    if (vm.IsShowDetail == true)
                    {
                        if (vm.IsFullHierarchy == true)
            ...
            else if (vm.ReportType.ToUpper() == ReportType_SubTrialBalance.ToUpper())
            {
                if (vm.DisplayType == DisplayType_Balance)
                {
            ...
            else if (vm.ReportType.ToUpper() == ReportType_Ledger.ToUpper())
            {
            ...
            else if (vm.ReportType.ToUpper() == ReportType_BalanceSheet.ToUpper())
            {
                if (vm.IsShowDetail == true)
                {
            ...
            else if (vm.ReportType.ToUpper() == ReportType_ProfitAndLoss.ToUpper())
            {
                if (vm.IsShowDetail == true)
                {
