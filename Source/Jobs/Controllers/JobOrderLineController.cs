...
namespace Jobs.Controllers
{
    ...
    public class JobOrderLineController : System.Web.Mvc.Controller
    {
        ...
        public ActionResult _Create(int Id, DateTime? date, string LineNature) //Id ==>Sale Order Header Id
        {
            ...
            var LastTrRec = (from p in db.JobOrderLine
                             where p.JobOrderHeaderId == Id
                             orderby p.JobOrderLineId descending
                             select new
                             {
            ...
            if (LastTrRec != null)
            {
                ...
                //s.UnitId = LastTrRec.UnitId;
                //s.DealUnitId = LastTrRec.DealUnitId;
                //s.UnitConversionMultiplier = LastTrRec.UnitConversionMultiplier;
            }
        ...
        public JsonResult GetLastTransactionDetailJson(int JobOrderHeaderId)
        {
            var LastTransactionDetail = _JobOrderLineService.GetLastTransactionDetail(JobOrderHeaderId);
