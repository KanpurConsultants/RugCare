        ...
        public ActionResult Delete(ReasonViewModel vm)
        {
            if (ModelState.IsValid)
            {
                ...
                foreach (var item in SaleEnquiryLine)
                {
                    ...
                    SaleOrderLine SOL = new SaleOrderLineService(_unitOfWork).Find_ByReferenceDocLineId(SaleEnquiryHeader.DocTypeId, item.SaleEnquiryLineId);
                    if (SOL != null)
                    {
                ...
                if (SOH != null)
                {
                    new SaleOrderHeaderService(_unitOfWork).Delete(SOH.SaleOrderHeaderId);
                }
