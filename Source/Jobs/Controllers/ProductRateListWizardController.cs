...
{
    [Authorize]
    public class ProductRateListWizardController : System.Web.Mvc.Controller
    {
        ...
        public ProductRateListWizardController(IUnitOfWork unitOfWork, IExceptionHandlingService exec)
        {
            _exception = exec;
        ...
        public ActionResult UpdateProductRate(int ProductId, decimal Rate, int RateListHeaderId)
        {
            XElement Modifications;
            bool Flag = new RateListLineService(_unitOfWork).UpdateRateListLineForProduct(ProductId, Rate, RateListHeaderId, User.Identity.Name, out Modifications);
