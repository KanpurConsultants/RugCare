              ...
              success: function (result) {
                  ...
                  if (result.Success == true) {
                      ...
                      if ($("#WagesPayType").val() == "Jobwork")
                      {
                          ...
                          $scope.gridOptions.columnDefs.push({ field: 'TDS', width: 110, cellClass: 'text-right cell-text ', headerCellClass: 'text-right header-text', enableCellEdit: true });
                      }
                      else
                      {
                          ...
                          $scope.gridOptions.columnDefs.push({ field: 'TDS', width: 110, cellClass: 'text-right cell-text ', headerCellClass: 'text-right header-text', enableCellEdit: false });
                      }
                      $scope.gridOptions.columnDefs.push({ field: 'TDSBaseValue', width: 100, visible: false });
                      $scope.gridOptions.columnDefs.push({ field: 'RetensionAmount', width: 100, visible: false });
                      ...
                      $scope.gridOptions.columnDefs.push({ field: 'Advance', width: 110, cellClass: 'text-right cell-text cell-Colour-Red ', headerCellClass: 'text-right header-text', enableCellEdit: true });

                      $scope.gridOptions.columnDefs.push({ field: 'XAdditions', width: 110, visible: false });
                      $scope.gridOptions.columnDefs.push({ field: 'XDeductions', width: 110, visible: false });
                      $scope.gridOptions.columnDefs.push({ field: 'XLoanEMI', width: 110, visible: false });
                      $scope.gridOptions.columnDefs.push({ field: 'XAdvance', width: 110, visible: false });
