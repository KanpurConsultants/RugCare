...
namespace Jobs.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IPackingReportService, PackingReportService>(new PerRequestLifetimeManager());
            ...
            container.RegisterType<IRugDashBoardBCService, RugDashBoardBCService>(new PerRequestLifetimeManager());
            ...
            container.RegisterType<IDocumentTypeTimeExtensionRequestService, DocumentTypeTimeExtensionRequestService>(new PerRequestLifetimeManager());
            ...
            Mapper.CreateMap<WeavingRetension, WeavingRetensionViewModel>();
            Mapper.CreateMap<WeavingRetensionViewModel, WeavingRetension>();

            Mapper.CreateMap<PersonGodown, PersonGodownViewModel>();
            Mapper.CreateMap<PersonGodownViewModel, PersonGodown>();
            ...
            Mapper.CreateMap<CostingHeader, DocumentUniqueId>();
            ...
            Mapper.CreateMap<WeavingReceiveQACombinedViewModel, DocumentUniqueId>();
            ...
            Mapper.CreateMap<WeavingRetension, WeavingRetension>();
            Mapper.CreateMap<PersonGodown, PersonGodown>();
            ...
            Mapper.CreateMap<DocumentTypeTimeExtensionRequest, DocumentTypeTimeExtensionRequestViewModel>();
            Mapper.CreateMap<DocumentTypeTimeExtensionRequestViewModel, DocumentTypeTimeExtensionRequest>();
            Mapper.CreateMap<DocumentTypeTimeExtension, DocumentTypeTimeExtension>();
            Mapper.CreateMap<DocumentTypeTimeExtensionRequest, DocumentTypeTimeExtensionRequest>();
            Mapper.CreateMap<ProductProcess, ProductProcess>();
