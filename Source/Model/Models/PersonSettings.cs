...
namespace Model.Models
{
    public class PersonSettings : EntityBase, IHistoryLog
    {
        ...
        [ForeignKey("DefaultTdsCategory"), Display(Name = "Default Tds Category")]
        public int? DefaultTdsCategoryId { get; set; }
        public virtual TdsCategory DefaultTdsCategory { get; set; }

        [ForeignKey("DefaultTdsGroup"), Display(Name = "Default Tds Group")]
        public int? DefaultTdsGroupId { get; set; }
        public virtual TdsGroup DefaultTdsGroup { get; set; }

        [ForeignKey("DefaultSalesTaxGroupParty")]
        public int? DefaultSalesTaxGroupPartyId { get; set; }
        public virtual ChargeGroupPerson DefaultSalesTaxGroupParty { get; set; }
