...
{
    public class ProductQualityBomDetail : EntityBase, IHistoryLog
    {
        public ProductQualityBomDetail()
        {
        }

        [Key]
        public int ProductQualityBomDetailId { get; set; }

        [ForeignKey("ProductQuality"), Display(Name = "Product Quality")]
