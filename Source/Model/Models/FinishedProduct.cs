...
namespace Model.Models
{
    public class FinishedProduct : Product
    {
        ...
        [ForeignKey("BaseProductGroup")]
        [Display(Name = "BaseProductGroup")]
        public int? BaseProductGroupId { get; set; }
        public virtual ProductGroup BaseProductGroup { get; set; }

        [ForeignKey("BaseProductSize")]
        [Display(Name = "BaseProductSize")]
        public int? BaseProductSizeId { get; set; }
        public virtual Size BaseProductSize { get; set; }
        ...
        public bool? IsConsumptionPcsWise { get; set; }
