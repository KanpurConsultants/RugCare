...
namespace Service
{
    public interface IStockLineService : IDisposable
    {
        ...
        decimal  ProductStockProcessBalance(int ProductId, int StockHeaderId, int? ProductUidId);
        ...
        IEnumerable<ComboBoxResult> GetPendingStockInForIssue_WithoutDimension(int id, int? ProductId, string term);
    ...
    public class StockLineService : IStockLineService
    {
        ...
        public IQueryable<ComboBoxResult> GetProdOrderHelpListForProduct(int Id, string term)
        {
            ...
            var list = (from p in db.ViewProdOrderBalance
                        join Pol in db.ProdOrderLine on p.ProdOrderLineId equals Pol.ProdOrderLineId into ProdOrderLineTable
        ...
        public StockLineViewModel GetStockLineForIssue(int id)
        {
            var temp = (from p in db.StockLine
                        ...
                        select new StockLineViewModel
                        {
                            ...
                            SaleOrderLineName = p.SaleOrderLine.SaleOrderHeader.DocNo,
        ...
        public decimal ProductStockProcessBalance(int ProductId, int StockHeaderId, int ? ProductUidId)
        {
            ...
            IEnumerable<ProductBalanceForProcessViewModel> FifoSaleOrderLineList;

            if (ProductUidId !=0)
                FifoSaleOrderLineList = db.Database.SqlQuery<ProductBalanceForProcessViewModel>("" + ConfigurationManager.AppSettings["DataBaseSchema"] + ".spStockProcessBalance  @UptoDate, @SiteId, @DivisionId, @PersonId, @ProcessId, @CostCenterId, @ProductId, @ProductUidId ", SqlParameterUptoDate, SqlParameterSiteId, SqlParameterDivisionId, SqlParameterPersonIdId, SqlParameterProcessId, SqlParameterCostCenterId, SqlParameterProductId, SqlParameterProductUidId).ToList();
            else
        ...
        public IEnumerable<ComboBoxResult> GetPendingStockInForIssue_WithoutDimension(int StockHeaderId, int? ProductId,  string term)
        {
        ...
        public IEnumerable<StockLineViewModel> GetBOMDetailForProducts(ProductsFilterViewModel vm)
        {
            ...
            var StockLineVm = (from H in vm.StockIssueForProductsFilterViewModel
                         ...
                         select new StockLineViewModel
                         {
                             ...
                             RequisitionBalanceQty = (decimal)Result.Sum(i => i.TempJobOrderBomTab.Qty / (decimal)i.TempJobOrderBomTab.IssueForQty * (decimal)i.H.Qty),
                             Qty = (decimal)Result.Sum(i => i.TempJobOrderBomTab.Qty / (decimal)i.TempJobOrderBomTab.IssueForQty * (decimal)i.H.Qty),
