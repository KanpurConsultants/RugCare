...
namespace Service
{
    public interface IJobOrderLineService : IDisposable
    {
        ...
        JobOrderLineViewModel GetJobOrderLine_ByProductId(int ProductId);
        ...
        JobOrderLastTransaction GetLastTransactionDetail(int JobOrderHeaderId);
    ...
    public class JobOrderLineService : IJobOrderLineService
    {
        ...
        public JobOrderLineViewModel GetJobOrderLine_ByProductId(int ProductId)
        {
            var temp = (from p in db.JobOrderLine
        ...
        {
            JobOrderLastTransaction LastTransactionDetail = (from L in db.JobOrderLine
                                                             join P in db.Product on L.ProductId equals P.ProductId into tableP
                                                             from TabP in tableP.DefaultIfEmpty()
                                                             orderby L.JobOrderLineId descending
                                                                where L.JobOrderHeaderId == JobOrderHeaderId
                                                                select new JobOrderLastTransaction
                                                                {
        ...
        public JobOrderLineViewModel GetLineDetailForReceive(int id, int ReceiveId)
        {
            ...
            return (from p in db.ViewJobOrderBalance
                    ...
                    select new JobOrderLineViewModel
                    {
                        ...
                        ExcessReceiveAllowedAgainstOrderQty = t1.Qty * settings.ExcessQtyAllowedPer/100
                    }).FirstOrDefault();
      ...
      public IEnumerable<ComboBoxResult> FGetUnitConversionForHelpList(int Id, string term)
        ...
        public IEnumerable<ComboBoxResult> GetPendingStockInForIssue(int JobOrderHeaderId, int? ProductId, int? Dimension1Id, int? Dimension2Id, int? Dimension3Id, int? Dimension4Id, string term)
        {
            ...
            return (from p in db.ViewStockInBalance
                    ...
                    && (string.IsNullOrEmpty(settings.filterProductTypes) ? 1 == 1 : ProductTypes.Contains(PGTab.ProductTypeId.ToString()))
    ...
    public class JobOrderLastTransaction
    {
        ...
        public Decimal DealUnitDecimalPlaces { get; set; }
    }
