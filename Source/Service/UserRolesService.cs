...
namespace Service
{
    public interface IUserRolesService : IDisposable
    {
        ...
        bool TryInsertUserRole(string UserId, string UserName, string RoleId);
    }
    ...
    public class UserRolesService : IUserRolesService
    {
        ...
        public UserRolesService(IDataContext Con, IUsersService userServ)
        {
            _context = Con;
            //_logger = log;
        ...
        public bool TryInsertUserRole(string UserId, string UserName, string RoleId)
        {

            _userService.Syncs(UserId, UserName);
