...
namespace Service
{
    public interface IBomDetailService : IDisposable
    {
        ...
        IEnumerable<ComboBoxResult> GetBaseProduct(int? ProductId, string term);
    ...
    public class BomDetailService : IBomDetailService
    {
        ...
        public IEnumerable<ComboBoxResult> GetBaseProduct(int? ProductId, string term)
        {
            IEnumerable<ComboBoxResult> list;

            if (ProductId != null)
            {
                list = (from BD in db.BomDetail
                        join P in db.Product  on BD.BaseProductId equals P.ProductId into PTable
            ...
            {
                list = (from F in db.FinishedProduct
                        where 1 == 1
                        orderby F.ProductName
                        select new ComboBoxResult
                        {
                            text = F.ProductName,
                            id = F.ProductId.ToString(),
                        });
            }
        ...
        public IEnumerable<DesignConsumptionLineViewModel> GetDesignConsumptionFaceContentForIndex(int BaseProductId)
        {
            ...
            IEnumerable<DesignConsumptionLineViewModel> svm = (from b in db.BomDetail
                                                               ...
                                                               select new DesignConsumptionLineViewModel
                                                               {
                                                                   ...
                                                                   ConsumptionPer = Math.Round(b.ConsumptionPer, 2),
                                                                   MainWeight = b.MainWeight,
                                                                   Qty = b.Qty,
                                                                   UnitName = UnitTab.UnitName
                                                               }).ToList();
        ...
        public DesignConsumptionLineViewModel GetDesignConsumptionLineForEdit(int BomDetailId)
        {
            ...
            DesignConsumptionLineViewModel svm = (from b in db.BomDetail
                                                  ...
                                                  select new DesignConsumptionLineViewModel
                                                  {
                                                      ...
                                                      ConsumptionPer = b.ConsumptionPer,
                                                      //ConsumptionPer = Math.Round(b.Qty * 100/Weight,2),
                                                      BaseProcessId = (int)b.BaseProcessId,
                                                      Weight = (Decimal)b.MainWeight,
                                                      Qty = b.Qty,
                                                      UnitName = UnitTab.UnitName
                                                  }).FirstOrDefault();
            return svm;
